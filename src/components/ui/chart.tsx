...
/**
 * NOTE:
 * Recharts types differ a lot between versions. To avoid breaking the build
 * when ui/* exists but charts aren't used, we keep this component version-agnostic.
 */
...
/**
 * Same story: make it tolerant to Recharts type differences.
 */
