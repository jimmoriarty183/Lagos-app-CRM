  ...
  return (
    <div className="flex flex-col gap-3 rounded-[24px] border border-[#DDE3F1] bg-[linear-gradient(125deg,#FFFFFF_0%,#F8FAFF_55%,#F1F5FF_100%)] px-4 py-4 shadow-[0_16px_34px_rgba(15,23,42,0.08)] lg:flex-row lg:items-center lg:justify-between">
      <div className="flex flex-wrap items-center gap-2.5">
        <div className="inline-flex rounded-[16px] border border-[#D8DFEA] bg-white p-1 shadow-[0_4px_14px_rgba(15,23,42,0.08)]">
          <button
            type="button"
            onClick={onPrevious}
        ...
        <button
          type="button"
          onClick={onToday}
          className="inline-flex h-10 items-center rounded-[14px] border border-[#CBD5E1] bg-white px-3.5 text-[13px] font-semibold text-[#1E293B] shadow-[0_3px_12px_rgba(15,23,42,0.06)] transition hover:border-[#C7D2FE] hover:text-[#3645A0]"
        >
          Today
        </button>
        ...
        <div>
          ...
          <div className="mt-0.5 text-[18px] font-semibold text-[#0F172A]">{periodLabel}</div>
        </div>
      </div>
