...
export function TodoDayView({
  ...
  const allDayItems = allItems.filter((item) => item.allDay || !isTimedItem(item));
  ...
  return (
    <div className="overflow-hidden rounded-[22px] border border-[#E5E7EB] bg-white shadow-[0_12px_30px_rgba(15,23,42,0.05)]">
      <div className="border-b border-[#F2F4F7] bg-[#FCFCFD] px-4 py-4">
        <div className="text-[11px] font-semibold uppercase tracking-[0.06em] text-[#98A2B3]">Focused day</div>
        <div className="mt-1 text-[20px] font-semibold text-[#111827]">{format(anchorDate, "EEEE, MMMM d")}</div>
      </div>

      <div className="border-b border-[#F2F4F7] px-4 py-4">
        <div className="mb-3 text-[11px] font-semibold uppercase tracking-[0.06em] text-[#98A2B3]">All day</div>
      ...
      <div className="overflow-x-auto">
        <div className="grid min-w-[720px] grid-cols-[72px_minmax(0,1fr)]">
          <div className="relative w-[72px] shrink-0 border-r border-[#F2F4F7] bg-[#FCFCFD]" style={{ height: CALENDAR_TIMELINE_HEIGHT }}>
          ...
          <div className="relative" style={{ height: CALENDAR_TIMELINE_HEIGHT }}>
