  ...
  return (
    ...
    >
          ...
          <button
            ...
            className={
              ...
              (compact
                ...
                : "inline-flex h-10 items-center rounded-lg border border-[#E5E7EB] dark:border-white/10 bg-white dark:bg-white/[0.03] px-3 text-[12px] font-semibold text-[#374151] dark:text-white/85 shadow-sm transition hover:border-[#C7D2FE] dark:hover:border-[var(--brand-500)]/40 hover:text-[#1F2937] dark:hover:text-white")
            }
          >
            <MoonStar
      ...
      <DialogContent className="flex max-h-[calc(100vh-2rem)] max-w-[680px] flex-col overflow-hidden rounded-[28px] border-[#E5E7EB] dark:border-white/10 bg-white dark:bg-white/[0.03] p-0 shadow-[0_24px_80px_rgba(15,23,42,0.18)]">
        <div className="flex min-h-0 flex-1 flex-col rounded-[28px] bg-[linear-gradient(180deg,#ffffff_0%,#F9FAFB_100%)] dark:bg-none dark:bg-[#0E0E1B]">
          <div className="min-h-0 flex-1 overflow-y-auto px-6 py-6 sm:px-7 sm:py-7">
            <DialogHeader>
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div>
                  <DialogTitle className="text-[22px] tracking-[-0.02em] text-[#111827] dark:text-white">
                    End day
                  </DialogTitle>
                ...
                {existingWorkDay?.status === "finished" ? (
                  <span className="inline-flex items-center gap-2 rounded-full border border-[#D1FADF] dark:border-emerald-500/30 bg-[#ECFDF3] dark:bg-emerald-500/10 px-3 py-1.5 text-xs font-semibold text-[#067647] dark:text-emerald-300">
            ...
            <div className="mt-6 space-y-5">
                      ...
                      <div className="mt-3 rounded-[18px] border border-[#E5E7EB] dark:border-white/10 bg-[#F9FAFB] dark:bg-white/[0.04] px-4 py-3">
                        ...
                        <div className="mt-2 space-y-2">
                          {completedToday.map((item) => (
                            <div
                              key={item.id}
                              className="rounded-[14px] border border-white dark:border-white/10 bg-white dark:bg-white/[0.03] px-3 py-2 text-sm text-[#374151] dark:text-white/85 shadow-[0_4px_12px_rgba(15,23,42,0.04)]"
                            >
                              {item.title}
                            </div>
                          ))}
                  ...
                  <section className="rounded-[22px] border border-[#E5E7EB] dark:border-white/10 bg-white dark:bg-white/[0.03] p-4 shadow-[0_8px_20px_rgba(15,23,42,0.04)]">
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <Button
                        ...
                        variant="outline"
                        size="sm"
                        className="h-9 rounded-[14px] border-[#E5E7EB] dark:border-white/10 bg-white dark:bg-white/[0.03] px-3 text-xs text-[#374151] dark:text-white/85 hover:border-[#C7D2FE] dark:hover:border-[var(--brand-500)]/40 hover:bg-[#F9FAFB] dark:hover:bg-white/[0.06]"
                        onClick={() =>
                      ...
                      <div className="mt-4 rounded-[18px] border border-[#E5E7EB] dark:border-white/10 bg-[#F9FAFB] dark:bg-white/[0.04] px-4 py-3">
                        ...
                        <div className="mt-2 space-y-2">
                          {existingTomorrowFollowUps.map((item) => (
                            <div
                              key={item.id}
                              className="flex items-center gap-2 rounded-[14px] border border-white dark:border-white/10 bg-white dark:bg-white/[0.03] px-3 py-2 text-sm text-[#374151] dark:text-white/85 shadow-[0_4px_12px_rgba(15,23,42,0.04)]"
                            >
              ...
              {errorMessage ? (
                <div className="rounded-[18px] border border-[#FECACA] dark:border-rose-500/30 bg-[#FEF2F2] dark:bg-rose-500/10 px-4 py-3 text-sm font-medium text-[#B42318] dark:text-rose-300">
                  {errorMessage}
                </div>
              ) : null}
            </div>
          ...
          <DialogFooter className="border-t border-[#E5E7EB] dark:border-white/10 px-6 py-4 sm:px-7">
            <Button
              type="button"
              variant="outline"
              className="rounded-[16px] border-[#E5E7EB] dark:border-white/10 bg-white dark:bg-white/[0.03] text-[#374151] dark:text-white/85 hover:border-[#C7D2FE] dark:hover:border-[var(--brand-500)]/40 hover:bg-[#F9FAFB] dark:hover:bg-white/[0.06]"
              onClick={() => {
                armOverlayCloseGuard();
                setOpen(false);
              }}
