      ...
      <div className="min-w-0">
        <div className="flex items-baseline justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
              <div className="text-[11px] font-medium text-[#9CA3AF]">{periodLabel}</div>
            <button
              type="button"
        ...
        {customRange?.active ? (
          <form method="get" className="mt-2 grid gap-2 rounded-xl border border-[#E5E7EB] bg-white p-3">
            ...
            <input
              ...
              className="h-10 rounded-lg border border-[#E5E7EB] px-3 text-sm outline-none focus:border-[#6366F1]"
            />
            <input
              type="date"
              name="send"
            ...
            <button
              type="submit"
              className="inline-flex h-10 min-w-[110px] items-center justify-center rounded-lg bg-[#6366F1] px-4 text-[12px] font-semibold text-white"
            >
              Apply range
            </button>
          </form>
        ...
        <div className="-mx-1 mt-2 flex snap-x snap-mandatory gap-2 overflow-x-auto px-1 pb-1">
          {cards.map((card) => {
            ...
            return (
              ...
              >
                <div className="text-[11px] font-semibold text-[#6B7280]">{card.label}</div>
                <div className={`mt-1.5 text-[20px] font-semibold tabular-nums ${valueCls}`}>
                  {card.value}
                </div>
                <div className="mt-1 text-[11px] font-medium text-[#9CA3AF]">{periodLabel}</div>
                {card.trendText ? (
