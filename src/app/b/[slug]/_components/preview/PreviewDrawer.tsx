      ...
      >
        ...
        <div className="sticky top-0 z-20 border-b border-[#E5E7EB] dark:border-white/10 bg-white/95 backdrop-blur">
          <div className="flex items-start justify-between gap-3 px-5 py-4">
            ...
            <button
              type="button"
              onClick={onClose}
              className="inline-flex h-10 w-10 items-center justify-center rounded-[16px] border border-[#E5E7EB] dark:border-white/10 bg-white dark:bg-white/[0.03] text-[#374151] transition hover:border-[#C7D2FE] hover:bg-[#F9FAFB]"
        ...
        {footerHref && footerLabel ? (
          <div className="border-t border-[#E5E7EB] dark:border-white/10 bg-white dark:bg-white/[0.03] px-5 py-3">
            <Link
              href={footerHref}
              className="inline-flex h-9 items-center rounded-xl border border-[#E5E7EB] dark:border-white/10 bg-white dark:bg-white/[0.03] px-3 text-sm font-semibold text-[#374151] transition hover:border-[#C7D2FE] hover:bg-[#F9FAFB]"
            >
              {footerLabel}
            </Link>
          </div>
