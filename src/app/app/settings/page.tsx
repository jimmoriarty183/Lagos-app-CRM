          ...
          <div className="w-full min-w-0">
            <div className="rounded-3xl border border-[#E5E7EB] bg-white/92 p-4 shadow-[0_20px_60px_rgba(15,23,42,0.08)] backdrop-blur">
              <div className="mb-3 flex items-center gap-3">
                <Link
                  href="/app/crm"
                  className="inline-flex items-center gap-1.5 rounded-full border border-[#E5E7EB] bg-white px-3 py-1 text-xs font-semibold text-[#374151] transition hover:border-[#D6DAE1] hover:bg-[#FCFCFD]"
                >
                  <ArrowLeft className="h-3.5 w-3.5" />
                  Back to CRM
                </Link>
                <div className="inline-flex items-center rounded-full border border-[#E5E7EB] bg-[#F9FAFB] px-3 py-0.5 text-[11px] font-semibold uppercase tracking-[0.14em] text-[#6B7280]">
                  Account settings
                </div>
              </div>
              ...
              <p className="mt-1 max-w-[560px] text-[13px] leading-4 text-[#6B7280]">
                ...
                >
                  <div className="flex items-center justify-between gap-3">
                    <div className="flex min-w-0 items-center gap-2.5">
                      <div className="inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-[#F3F4F6] text-[#4B5563]">
                        <UserCircle2 className="h-[18px] w-[18px]" />
                      </div>
                      <div className="min-w-0">
                        <div className="text-base font-semibold leading-tight text-[#111827]">Profile</div>
                        <div className="truncate text-xs leading-4 text-[#6B7280]">
                          View your account identity and contact details.
                        </div>
                      </div>
                    </div>
                    <ChevronRight className="h-4 w-4 shrink-0 text-[#9CA3AF] transition group-hover:text-[#4B5563]" />
                  </div>
                </Link>
              ...
              <div className="mt-3 rounded-xl border border-[#E5E7EB] bg-[#F9FAFB] p-3">
                ...
                {adminHref ? (
                  <Link
                    href={adminHref}
                    className="mt-2 inline-flex items-center gap-2 rounded-full border border-[#E5E7EB] bg-white px-2.5 py-1 text-[11px] font-semibold text-[#374151] shadow-sm transition hover:border-[#D6DAE1] hover:bg-[#FCFCFD]"
                  >
