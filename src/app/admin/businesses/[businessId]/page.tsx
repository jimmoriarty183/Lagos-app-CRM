...
export default async function AdminBusinessDetailPage({
  ...
  return (
    <AdminShell
      ...
      actions={
        <Link href="/admin/businesses" className="rounded-xl border border-slate-300 dark:border-white/15 bg-white dark:bg-white/[0.03] px-3 py-2 text-sm font-medium text-slate-700 dark:text-white/80 transition hover:border-slate-400 hover:text-slate-900 dark:hover:text-white">
          Назад к списку
        </Link>
      }
    >
