                ...
                <AdminCell>
                  <div className="flex flex-wrap gap-2">
                    ...
                    {item.billingPlanCode ? (
                      <AdminBadge label={translateLabel(item.billingPlanCode.toUpperCase())} tone="bg-slate-100 dark:bg-white/[0.06] text-slate-700 dark:text-white/80" />
                    ) : item.plan ? (
                      <AdminBadge label={translateLabel(item.plan.toUpperCase())} tone="bg-slate-100 dark:bg-white/[0.06] text-slate-700 dark:text-white/80" />
                    ) : null}
                  </div>
                </AdminCell>
              </AdminTableRow>
